...
exports.buydatanew =  async (req, res) => {
    const userid = req.body.userId;
...
exports.buydatageneral=  async (req, res) => {
    const decryptedData = req.decryptedData;
    const { userId, number, id, network, refid } = decryptedData;
    ...
    try {
        ...
        const amount=product.tamount;
const o=gm.tamount < product.tamount;
