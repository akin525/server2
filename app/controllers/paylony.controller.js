...
exports.paylony =  async (req, res) => {
    var data=req.body;



    const account = data.receiving_account;
    const refid = data.reference;
    const amount = data.amount;
    const nar= data.sender_narration;
    try {
        const user = await User.findOne({ where: { account_number: account } });
